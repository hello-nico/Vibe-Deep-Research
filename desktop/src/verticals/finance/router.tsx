...
export const router = createBrowserRouter([
  {
    ...
    children: [
      ...
      { path: "/sectors", lazy: async () => ({ Component: (await import("@/pages/IndustryProfiles")).IndustryProfiles }) },
      { path: "/sectors/:key", lazy: async () => ({ Component: (await import("@/pages/IndustryProfiles")).IndustryProfiles }) },
