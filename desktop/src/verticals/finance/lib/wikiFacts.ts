...
const METRIC_LABELS: Record<string, string> = {
  ...
  electricity_generated: '发电量',
  electricity_sold: '售电量',
  installed_capacity: '装机容量',
  installed_capacity_hydro: '水电装机容量',
  installed_capacity_controllable: '可控装机容量',
  settlement_tariff: '结算电价',
  fuel_cost_per_mwh: '度电燃料成本',
  coal_purchase_price: '入炉标煤单价',
  heat_supplied: '供热量',
};
