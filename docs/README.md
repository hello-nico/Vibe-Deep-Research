...
- [M9.8：对象上下文驱动的问助手（Ask / Agent）](问助手双模式与Agent面板_Task_M9.8_2026-09-20.md) — 默认 Ask 只读；引用业务对象与版本，Agent 经 Backend 维护资料与知识，数据先更新、判断按需更新；与 M9.7 共用研究后 hook。六包代码已落地，真实模型/浏览器与现用服务部署待验收。
